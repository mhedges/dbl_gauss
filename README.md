Attempt to understand fitting Lanthanum Bromide (LaBr) crystal response in Mu2e STM (double gaussian?) using ROOT supported vectorization and parallelization.
